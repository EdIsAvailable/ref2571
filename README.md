...
Идея: Ранее созданный месседжер наделить возможностью работать на платформе Linux с использованием клиент-серверной архитектуры с реализацией возможности хранения данных в БД MySql на сервере.
